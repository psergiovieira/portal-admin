    ...
    render() {
        ...
        return (<div className="App">
            <div className="wrapper fadeInDown">
                ...
                <div id="formContent">
                    <div className={'form-group' + (submitted && !username ? ' alert alert-danger alert-dismissible' : '')}>
                        {submitted && !username && <div id="idErrorLogin" ><strong>Error!</strong> Login or Password</div> }
                    </div>
